...
def fetch_FGG_energy_values_SQL(dsbutton1, dsbutton3, freqbutton1, freqbutton2, freqbutton3):
    if(dsbutton1== 'sunken' and freqbutton1== 'sunken'):
...
def fetch_lagrange_energy_values_SQL(dsbutton1, dsbutton3, freqbutton1, freqbutton2, freqbutton3):
    if(dsbutton1== 'sunken' and freqbutton1== 'sunken'):
...
def fetch_FGG_time_values_SQL(dsbutton1, dsbutton3, freqbutton1, freqbutton2, freqbutton3):
    if(dsbutton1== 'sunken' and freqbutton1== 'sunken'):
...
def fetch_lagrange_time_values_SQL(dsbutton1, dsbutton3, freqbutton1, freqbutton2, freqbutton3):
    if(dsbutton1== 'sunken' and freqbutton1== 'sunken'):
